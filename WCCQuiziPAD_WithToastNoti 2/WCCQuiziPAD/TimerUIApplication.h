...
#define kApplicationDidTimeoutNotification2 @"AppTimeOut2"

#define kWarningTimeoutNotification2 @"ToastTimeOut2"

//#define kApplicationDidTimeoutNotification3 @"AppTimeOut3"

@interface TimerUIApplication : UIApplication
{
    NSTimer     *myidleTimer;
    NSTimer *quizEndTimer;
}
@property (assign, nonatomic) int timer2ExceedTimeInSeconds;
@property (assign, nonatomic) int ToastAppearTimeInSeconds;
@property (assign, nonatomic) int idleTimerExceedTimeInSeconds;
-(void)resetIdleTimer;
-(void)resetQuizTimer;
