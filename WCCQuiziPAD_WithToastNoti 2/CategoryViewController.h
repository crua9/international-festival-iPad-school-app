...
@property (strong, nonatomic) IBOutlet UIButton *cat1;
@property (strong, nonatomic) IBOutlet UIButton *cat2;
@property (strong, nonatomic) IBOutlet UIButton *cat3;
@property (strong, nonatomic) IBOutlet UIButton *catAll;
@property (strong, nonatomic) IBOutlet UIView *popUpViewForMainScreen;
